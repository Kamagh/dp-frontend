export default [
    {
        id: 1,
        name: 'Pharmacy One',
        latitude: 40.199965 + (Math.random() * 0.05 - 0.025),  // Random location within a larger radius
        longitude: 44.5436319 + (Math.random() * 0.05 - 0.025),
        products: [
    ...
    },
    {
        id: 2,
        name: 'Pharmacy Two',
        latitude: 40.199965 + (Math.random() * 0.05 - 0.025),
        longitude: 44.5436319 + (Math.random() * 0.05 - 0.025),
        products: [
    ...
    ...Array.from({ length: 8 }, (_, i) => ({
        id: i + 3,
        name: `Pharmacy ${i + 3}`,
        latitude: 40.199965 + (Math.random() * 0.05 - 0.025),  // Larger variation for more spread
        longitude: 44.5436319 + (Math.random() * 0.05 - 0.025),
        products: [
